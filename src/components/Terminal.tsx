...
const commands: Command[] = [
  {
    ...
    output: (
      <div className="mb-4 flex items-center gap-3">
        ...
        <div>
          <span className="text-white font-bold block">Diffusion</span>
  ...
  },
  {
    ...
    output: (
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4 text-sm font-medium">
        <div className="relative overflow-hidden p-4 rounded border border-white/10 flex flex-col items-center justify-center text-center h-auto py-6 cursor-default group transition-all">
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-100 text-xs leading-relaxed px-2 drop-shadow-lg font-medium">Dive deeper into scripture with AI-powered insights and guided study plans.</p>
          </div>
        </div>
        <div className="relative overflow-hidden p-4 rounded border border-white/10 flex flex-col items-center justify-center text-center h-auto py-6 cursor-default group transition-all">
          <video autoPlay loop muted playsInline className="absolute inset-0 w-full h-full object-cover opacity-40 group-hover:opacity-50 transition-opacity z-0">
          ...
          <div className="relative z-10">
             ...
             <p className="text-gray-100 text-xs leading-relaxed px-2 drop-shadow-lg font-medium">Effortlessly track your daily intake and reach your fitness goals with smart analytics.</p>
          </div>
        </div>
      </div>
    ),
